...
var helpers = {
  ...
  Progress: function (width) {
    ...
    this.update = function (currentValue, maxValue, numOfDecimalPlaces) {
      if(typeof numOfDecimalPlaces === 'undefined') {
      ...
      return '['+
        ...
        Array(width + 1 - barLength).join("-") +    //The empty portion
      '] ' + clc.blackBright(Math.round10(currentValue / maxValue * 100, numOfDecimalPlaces) + '%');
    };
  },
